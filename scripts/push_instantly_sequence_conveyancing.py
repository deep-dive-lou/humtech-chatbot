"""
Push 14-email outreach sequence to Instantly campaign — CONVEYANCING version.

Adapted from debt-management sequence. Changes:
- "financial services firms" → "property and conveyancing firms"
- "financial advice" → "conveyancing services"
- "advisors" → "fee earners" (where contextually appropriate)
- "firms in financial services" → "firms in property and conveyancing"

Campaign: 8c3f515b-2058-45bc-af6f-9d03f47d0833 (conveyancing-q1-2026)
"""
...
CAMPAIGN_ID = "8c3f515b-2058-45bc-af6f-9d03f47d0833"
...
STEPS = [
    ...
    # Email 3 - Day 8 (delay 4) — CHANGED: financial services → property/conveyancing
    {
        "type": "email",
        "delay": 4,
        "variants": [{
            ...
            "body": (
                ...
                "Most property and conveyancing firms like {{companyName}} discover \u00a3200k+ revenue leakage "
                "hiding in plain sight. RESG UK increased revenue by 400% from 2023-2024 - the "
                "competition couldn't keep up.\n\n"
                "Quick question: when potential clients enquire about conveyancing services, what % convert to "
                "instructed matters? Our clients hit 34% improvement within 60 days...\n\n"
                "The gap? Fee earners guessing scripts and performing repetitive tasks, instead of "
                "focusing on revenue generating tasks only. We've seen teams:\n\n"
    ...
    # Email 6 - Day 24 (delay 7) — CHANGED: advisors → fee earners
    {
        "type": "email",
        "delay": 7,
        "variants": [{
            "subject": "{{firstName}} - how many hours do fee earners waste on admin?",
            "body": (
                "Hi {{firstName}},\n\n"
                "What % of your team's day goes to manual data entry, follow-ups, and chasing clients?\n\n"
                "Industry average: 4.2 hours/day per fee earner. That's 1,100 hours/year per person lost to "
                ...
                "Fee earners focus 100% on closing.\n\n"
                "Result: 2-4 extra hours/day per fee earner = \u00a3187k avg. capacity increase Year 1. Zero "
                "software swap. Does automating the busywork (so they close) sound worth 3 minutes?\n\n"
    ...
    # Email 7 - Day 31 (delay 7) — CHANGED: financial services → property and conveyancing
    {
        "type": "email",
        "delay": 7,
        "variants": [{
            ...
            "body": (
                ...
                "We've seen so many firms in property and conveyancing miss the silent killers which eat "
                ...
                "What you fix: Bottlenecks, process leaks, revenue gaps.\n\n"
...
def main():
    ...
    with open("scripts/instantly_payload_conveyancing.json", "w", encoding="utf-8") as f:
